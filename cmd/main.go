...
import (
	...
	sampleissuerv1alpha1 "github.com/Infisical/infisical-issuer/api/v1alpha1"
...
func main() {
	...
	if err = (&controller.IssuerReconciler{
		...
		HealthCheckerBuilder:     signer.HealthCheckerFromIssuerAndSecretData,
	...
	if err = (&controller.CertificateRequestReconciler{ // TODO (dangtony98): Update?
		...
		Scheme:                   mgr.GetScheme(),
		ClusterResourceNamespace: clusterResourceNamespace,
		SignerBuilder:            signer.SignerFromIssuerAndSecretData,
